...
class _HomeMoviePageState extends State<HomeMoviePage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => {
          Provider.of<MovieListCubit>(context, listen: false)
            ..getNowPlayingMovies(),
          Provider.of<PopularMoviesCubit>(context, listen: false)
            ..getPopularMovies(),
          Provider.of<TopRatedMoviesCubit>(context, listen: false)
            ..getTopRatedMovies()
        });
  }
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              BlocBuilder<PopularMoviesCubit, PopularState>(
                  builder: (context, data) {
              ...
              BlocBuilder<TopRatedMoviesCubit, TopRatedState>(
                  builder: (context, data) {
                final state = data.state;
                if (state == RequestState.Loading) {
                  return Center(
